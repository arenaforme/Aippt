...
AI演示眼（英文名：nano banana pro）是一款基于 AI 的原生 PPT 生成应用，支持从想法、大纲或详细描述自动生成完整的演示文稿。通过先进的 AI 技术，您可以：
...
- 格式：PowerPoint 2016+ 兼容
- 比例：16:9
- 包含可编辑的文本框，可在 PowerPoint/WPS 中修改文字
...
### 9.5 PDF 转可编辑 PPTX（高级会员）

> 仅高级会员可用，入口在「会员中心」页面

将已有的 PDF 演示文稿转换为可编辑的 PPTX 文件：
