...
const faqs = [
  ...
  {
    question: '为什么导出的可编辑 PPTX 中有些文字缺失或错误？',
    answer:
      '可编辑 PPTX 功能使用 OCR（光学字符识别）和 AI 大模型技术从图片中提取文字。由于技术限制，可能存在以下情况：1）复杂背景、艺术字体或特殊排版的文字可能无法完全识别；2）部分文字可能识别不准确；3）图片背景中的装饰性文字可能被误提取。建议导出后检查并手动修正关键内容。',
  },
];
